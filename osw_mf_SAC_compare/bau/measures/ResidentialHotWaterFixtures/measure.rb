...
class ResidentialHotWaterFixtures < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    units.each_with_index do |unit, unit_index|
      ...
      runner.registerInfo("The day shift for this loop is at #{d_sh}.")
      ...
      runner.registerInfo("The unit name that is being looped is #{unit.name.to_s}.")
      runner.registerInfo("The unit value that is being looped is #{unit_index.to_i.to_s}.") # unit_index is an integer that I want
      ...
      if sh_gpd > 0
        ...
        runner.registerInfo(" The shower day shift for this loop is #{d_sh}.\n") #remove
      ...
      # increment days shift by 7 for each building unit // turned off for bau case with DHW gas sensitivities
      #d_sh += 7
